...
gobindata:
	go generate github.com/eriktate/truss/gengokit/template

# Install truss and protoc-gen-truss-protocast
truss: gobindata
	go install github.com/eriktate/truss/cmd/protoc-gen-truss-protocast
	go install -ldflags '-X "main.Version=$(SHA)" -X "main.VersionDate=$(VERSION_DATE)"' github.com/eriktate/truss/cmd/truss
